...
const ANIMATIONS = {
	"general": {
		...
		"turn_k": {"path": "res://index/design/image/animation/kngiht_action_x4_y2.png", "x_frames": 4, "y_frames": 2, "start_frame": 0, "end_frame": 1, "speed": 7},
	...
	"attack": {
		...
		"slash": {"path": "res://index/design/image/animation/kngiht_action_x4_y2.png", "x_frames": 4, "y_frames": 2, "start_frame": 4, "end_frame": 6, "speed": 10},
