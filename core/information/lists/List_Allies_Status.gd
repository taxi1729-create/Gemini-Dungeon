...
const DATA = {
	"knight": { "id": "knight",
		"name_jp": "ナイト",
		"hp": 20, "max_hp": 20,
		"spd": 3, "def": 1,"atk": 0,"shield":0,
		"ap": 3, "max_ap": 5,"color":Color.GREEN,"side":"ally","is_defeat":false
		,"icon": "sword_icon", "motion_group": "knight_motions","flip_h": true,"status_effects":{}
	},
	"witch": { "id": "witch",
		"name_jp": "ウィッチ",
		"hp": 15, "max_hp": 15,
		"spd": 6, "def": 0,"atk": 0,"shield":0,
		"ap": 3, "max_ap": 5,"color":Color.PURPLE,"side":"ally","is_defeat":false,
		"icon": "potion_icon", "motion_group": "witch_motions","flip_h": false,"status_effects":{}
	}
}
