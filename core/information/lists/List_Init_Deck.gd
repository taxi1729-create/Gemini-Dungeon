...
const KNIGHT_DECK = [
"strike","strike","strike","action_accel",
"action_accel",
"firebolt","firebolt"
]
...
"block","block","block","action_accel","action_accel",
"firebolt","firebolt","weak_point","weak_point","weak_point",
"weak_point","companion_block","force"
]
